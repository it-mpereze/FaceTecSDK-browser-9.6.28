...
var PhotoIDScanProcessor = /** @class */ (function () {
    function PhotoIDScanProcessor(sessionToken, sampleAppControllerReference) {
                ...
                if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                    try {
                        ...
                        if (responseJSON.wasProcessed === true) {
                            ...
                            "Frente de Credencial Capturado", // Successful scan of ID front-side (ID Types that do have a back-side).
                            "Reverso de Credencial Capturado", // Successful scan of the ID back-side.
                            "Pasaporte Capturado", // Successful scan of a Passport
        ...
        "Subiendo<br/>Escaneo de ID<br/>Encriptado", // Upload of ID front-side has started.
