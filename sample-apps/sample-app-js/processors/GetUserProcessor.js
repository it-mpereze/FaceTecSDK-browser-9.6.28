...
//
var GetUserProcessor = void 0;
//
// This is an example self-contained class to perform Authentication with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var GetUserProcessor = /** @class */ (function () {
    function GetUserProcessor(sampleAppControllerReference) {
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config.BaseURL + "/3d-db/get");
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        alert("El nombre de usuario " + _this.sampleAppControllerReference.getLatestEnrollmentIdentifier() + 
                        " ya existe en el grupo " + _this.sampleAppControllerReference.getGroupName());
                    }
                    else {
                        alert("El nombre de usuario " + _this.sampleAppControllerReference.getLatestEnrollmentIdentifier() + 
                        " está disponible en el grupo "+ _this.sampleAppControllerReference.getGroupName());
                    }
    ...
    //
    GetUserProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    GetUserProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return GetUserProcessor;
}());
var GetUserProcessor = GetUserProcessor;
