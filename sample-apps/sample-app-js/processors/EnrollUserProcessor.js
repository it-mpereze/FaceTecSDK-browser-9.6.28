...
//
var EnrollUserProcessor = void 0;
//
// This is an example self-contained class to perform Authentication with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var EnrollUserProcessor = /** @class */ (function () {
    function EnrollUserProcessor(sampleAppControllerReference) {
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config.BaseURL + "/3d-db/enroll");
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        alert("El usuario se agregó éxitosamente al grupo " + _this.sampleAppControllerReference.getGroupName());
                    }
                    else {
    ...
    //
    EnrollUserProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    EnrollUserProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return EnrollUserProcessor;
}());
var EnrollUserProcessor = EnrollUserProcessor;