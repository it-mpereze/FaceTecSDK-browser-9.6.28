...
//
var DeleteUserProcessor = void 0;
//
// This is an example self-contained class to perform Authentication with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var DeleteUserProcessor = /** @class */ (function () {
    function DeleteUserProcessor(sampleAppControllerReference) {
        ...
        //
        this.latestNetworkRequest = new XMLHttpRequest();
        this.latestNetworkRequest.open("POST", Config.BaseURL + "/3d-db/delete");
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        alert("El usuario se eliminó éxitosamente del grupo " + _this.sampleAppControllerReference.getGroupName());
                    }
                    else {
    ...
    //
    DeleteUserProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    DeleteUserProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return DeleteUserProcessor;
}());
var DeleteUserProcessor = DeleteUserProcessor;