...
//
var Authenticate3d2dProcessor = void 0;
//
// This is an example self-contained class to perform Authentication with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var Authenticate3d2dProcessor = /** @class */ (function () {
    function Authenticate3d2dProcessor(sampleAppControllerReference) {
        ...
        var parameters = {
            ...
            image: this.sampleAppControllerReference.getImage_1(),
            minMatchLevel: 4,
        };
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        if(responseJSON.meta.message!=null)
    ...
    //
    Authenticate3d2dProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    Authenticate3d2dProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return Authenticate3d2dProcessor;
}());
var Authenticate3d2dProcessor = Authenticate3d2dProcessor;
