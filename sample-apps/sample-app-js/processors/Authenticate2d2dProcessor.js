...
//
var Authenticate2d2dProcessor = void 0;
//
// This is an example self-contained class to perform Authentication with the FaceTec SDK.
// You may choose to further componentize parts of this in your own Apps based on your specific requirements.
//
var Authenticate2d2dProcessor = /** @class */ (function () {
    function Authenticate2d2dProcessor(sampleAppControllerReference) {
        ...
        var parameters = {
            image0: this.sampleAppControllerReference.getImage_1(),
            image1: this.sampleAppControllerReference.getImage_2(),
            minMatchLevel: 4
        };
        //
            ...
            if (_this.latestNetworkRequest.readyState === XMLHttpRequest.DONE) {
                try {
                    ...
                    if (responseJSON.success === true) {
                        ...
                        alert("La authenticación terminó con Match Level Nivel: " + responseJSON.matchLevel);
                    }
                    else {
    ...
    //
    Authenticate2d2dProcessor.prototype.onFaceTecSDKCompletelyDone = function () {
        //
    ...
    //
    Authenticate2d2dProcessor.prototype.isSuccess = function () {
        return this.success;
    };
    return Authenticate2d2dProcessor;
}());
var Authenticate2d2dProcessor = Authenticate2d2dProcessor;
